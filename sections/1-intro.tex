...
1997 gelang IBM mit Deep Blue der erste Sieg in Schach gegen den damaligen Weltmeister Garry Kasparow~(\cite{Campbell}\todo{Sekundärquelle nicht in Literaturverzeichnis!!!} in \cite{Tredinnick2017}). 2011 gelang es IBM schliesslich mit ihrem System namens Watson die amerikanische Quiz-Show Jeopardy zu gewinnen. Dieser Sieg ist ein Meilenstein für die künstliche Intelligenz. Mit Watson leistete IBM Pionierarbeit bei der Sammlung und Verarbeitung von unstrukturierten sowie strukturierten Daten~\autocite{Tredinnick2017}.
