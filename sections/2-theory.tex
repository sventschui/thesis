...
\todo[inline]{Darauf eingehen was einen Wettbewerbsvorteil ausmacht (e.g. VRIO)}

\todo[inline]{Gründe für die Automatisierung eines Geschäftsprozesses
...
- Produktgestaltung (Zusatznutzen nach SG Mgmnt Modell)

- Preisdifferenzierung bzw. Hybride Strategie zur Sicherung einer Monopolstellung -> evtl. auf Tech Giganten eingehen (monopolstellung dieser und/oder bedrohung durch diese in anderen Branchen)

- Marken/Image Auswirkung durch Customer Experience

- Kundenbedingung (vgl. CRM im SG Mgmnt Modell, dadurch Zusatzkäufe, etc.) durch Customer Experience

- Zur wichtigkeit von customer experience recherchieren

- Siehe optimierung und erneuerung in capaul}
...
\subsection{Automatisierung von Geschäftsprozessen}

- Was macht eine erfolgreiche Automatisierung aus?
