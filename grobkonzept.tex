...
\begin{tikzpicture}[
  node distance=2cm and 15cm
]

\node (startPost) [startstop] {Einreichung per Post};
\node (startWeb) [startstop, right=of startPost] {Einreichung per Kundenportal};
\node (startApp) [startstop, right=of startWeb] {Einreichung per App};
\node (in1) [io, below of=startPost=] {Test Input};
...
- Einreichung per Portal

-- Photo in der App / Photo im Kundenportal hochladen
...
- Weiterverarbeitung der Rechnungen
