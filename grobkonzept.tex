...
\todo[inline, color=igloo]{Argumentation für die steigenden Kosten}
...
\todo[inline, color=igloo]{Hinweis/Vorschlag: Bei "neu eingeführten" Begriffen, die nicht jeder Mensch alltäglich verwendet, sollten formal beim ersten Mal hervorgehoben werden (z.B. in Anführungszeichen oder kursiv schreiben). Das hilft dem Leser zu erkennen, dass diese Begriffe neu und wichtig sind und dann gleich eingeführt werden (kleiner Trick beim Schreiben ;)). Ab dem zweiten Gebrauch werden sie normal geschrieben, wie der Fliesstext. }
...
\todo[inline, color=igloo]{Vorschlag: In einer Thesis ist es wichtig, Abwechslung zu bringen, bspw. mit Tabellen oder Bildern. Hier würde es die Möglichkeit geben, eine kleine Tabelle zu machen mit den beiden Begriffen "tiers payant" und "tiers garant", bspw. 4 Kacheln (2 Zeilen, 2 Spalten). Oberste Zeile Tiers payant, Tiers garant und unterste Zeile in kurzen Worten eine Definition. Dann folgt die Erläuterung per Fliesstext.}
