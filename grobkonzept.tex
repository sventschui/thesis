...
\newcommand{\mysection}[1]{\vspace*{200pt}\section{#1}}
...
Ein Problem von RNNs ist, dass nur ein Kurzzeitgedächtnis zur Verfügung steht. Liegen Informationen etwas länger zurück, sprich der Abstand zwischen den beiden relevanten Neuronen ist zu gross, so gehen die diese verloren. Eine Lösung für diese Problematik bieten Long-Short-Term-Memory (kurz LSTM) Netzwerke. Diese spezialform von Recurrent Neural Networks die auf vier, anstelle einer einzelnen, internen Schicht basieren~\autocite{Olah2015UnderstandingNetworks}.
\todo[inline,color=red]{HIER NOCH WEITER SCHREIBEN}
\begin{figure}[h]
